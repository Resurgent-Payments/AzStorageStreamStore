...
//    //private readonly Channel<WriteToStreamArgs> _streamWriterChannel;
...
//    //    _streamWriterChannel = Channel.CreateUnbounded<WriteToStreamArgs>(new UnboundedChannelOptions {
//    //        SingleReader = true,
//    //        SingleWriter = false,
//    //        AllowSynchronousContinuations = false
//    //    });
...
//    //    await _streamWriterChannel.Writer.WriteAsync(new WriteToStreamArgs(tcs, id, version, events));
